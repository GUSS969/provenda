...
@section('content')
    <style>
        ...
        .page-header::before {
            ...
            right: 0;
            bottom: 0;
            a background: url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23ffffff' fill-opacity='0.05'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
            opacity: 0.3;
        }
                    ...
                    <div class="row g-3 align-items-end">
                        <div class="col-lg-4 col-md-6">
                            ...
                            <div class="search-box">
                                ...
                                <input type="text" name="search" class="form-control"
                                    placeholder="Cari nama event, lokasi..." value="{{ request('search') }}">
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            ...
                            <select name="kategori" class="form-select filter-select">
                                ...
                                <option value="Olahraga" {{ request('kategori') == 'Olahraga' ? 'selected' : '' }}>Olahraga
                                </option>
                                <option value="Seni & Budaya"
                                    {{ request('kategori') == 'Seni & Budaya' ? 'selected' : '' }}>Seni & Budaya</option>
                                <option value="Teknologi" {{ request('kategori') == 'Teknologi' ? 'selected' : '' }}>
                                    Teknologi</option>
                                <option value="Pendidikan" {{ request('kategori') == 'Pendidikan' ? 'selected' : '' }}>
                                    Pendidikan</option>
                                <option value="Festival" {{ request('kategori') == 'Festival' ? 'selected' : '' }}>Festival
                                </option>

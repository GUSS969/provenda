                ...
                <div class="card border-0 shadow-sm mt-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="ms-4">{{ \Carbon\Carbon::parse($event->tanggal)->format('d F Y') }}</span>
                        </div>
                        <div class="mb-3">
                            <i class="ti ti-clock text-purple"></i>
                            <strong>Waktu:</strong><br>
                            <span class="ms-4">{{ \Carbon\Carbon::parse($event->tanggal)->format('H:i') }} WIB</span>
                        </div>
                        <div class="mb-3">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <p>
                                    @if(\Carbon\Carbon::parse($event->tanggal)->isFuture())
                ...
                <div class="card border-0 shadow-sm h-100">
                    ...
                    <div class="card-body">
                        ...
                        <p class="text-muted small mb-2">
                            <i class="ti ti-calendar"></i> {{ \Carbon\Carbon::parse($relatedEvent->tanggal)->format('d M Y') }}
                        </p>

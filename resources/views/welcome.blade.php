...
<html lang="en" data-pc-preset="preset-1" data-pc-sidebar-caption="true" data-pc-direction="ltr" dir="ltr" data-pc-theme="light">
  ...
  <head>
    <title>Home | Datta Able Dashboard Template pia</title>
    <!-- [Meta] -->
    <meta charset="utf-8" />
    ...
    <link rel="stylesheet" href="./admin/assets/fonts/phosphor/duotone/style.css" />
        ...
        <div class="dropdown-body header-notification-scroll relative py-4 px-5"
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="./admin/assets/images/user/avatar-1.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="./admin/assets/images/user/avatar-2.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="./admin/assets/images/user/avatar-3.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="./admin/assets/images/user/avatar-4.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
          ...
          <div class="card mb-2">
            <div class="card-body">
              <div class="flex gap-4">
                <div class="shrink-0">
                  <img class="img-radius w-12 h-12 rounded-0" src="./admin/assets/images/user/avatar-5.jpg" alt="Generic placeholder image" />
                </div>
                <div class="grow ms-3">
...
<!-- [ Header ] end -->
                ...
                <div class="table-responsive">
                  <table class="table table-hover">
                    <tbody>
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="./admin/assets/images/user/avatar-1.jpg" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="./admin/assets/images/user/avatar-2.jpg" alt="activity-user" />
                        </td>
                        <td>
                      ...
                      <tr class="unread">
                        <td>
                          <img class="rounded-full max-w-10" style="width: 40px" src="./admin/assets/images/user/avatar-3.jpg" alt="activity-user" />
                        </td>
                        <td>
    ...
    <script src="./admin/assets/js/icon/custom-icon.js"></script>

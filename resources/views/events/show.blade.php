        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item">
                    <a href="{{ route('user.home') }}" class="text-white">Beranda</a>
                </li>
                <li class="breadcrumb-item">
                    <a href="{{ route('user.events') }}" class="text-white">Event</a>
                </li>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-5 mb-4">
                ...
                @else
                    <div class="gradient-bg d-flex align-items-center justify-content-center rounded shadow-lg"
                         style="height: 400px;">
                ...
                <div class="card border-0 shadow-sm mt-4">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <span class="ms-4">
                                {{ \Carbon\Carbon::parse($event->tanggal_event)->format('H:i') }} WIB
                            </span>
                        </div>
                            ...
                            <div class="card border-0 shadow-sm mt-4"
                                ...
                                <div class="card-body">
                                    ...
                                    @if($event->registration_info)
                                        <div class="alert alert-warning">
                                            <h6 class="fw-bold mb-2">
                                                <i class="ti ti-info-circle"></i> Persyaratan Pendaftaran:
                                            </h6>
                                    ...
                                    @php
                                        $isFull = false;
                                        if ($event->max_participants) {
                                            $isFull = ($event->umkmRegistrations->count() >= $event->max_participants);
                                        }
                                    @endphp
                                    ...
                                    @if($isFull)
                                        <div class="alert alert-danger text-center py-4">
                                            ...
                                            <p class="mb-0">
                                                Maaf, semua slot pendaftaran telah terisi.
                                            </p>
                                        </div>
                                    @else
                                        <p class="text-muted mb-3">
                                            <i class="ti ti-info-circle"></i>
                                            Event ini terbuka untuk pelaku UMKM. Daftarkan UMKM Anda sekarang!
                                        </p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card border-0 shadow-sm h-100">
                        ...
                        @if($relatedEvent->poster)
                            <img src="{{ route('poster.show', basename($relatedEvent->poster)) }}"
                                 class="card-img-top"
                        ...
                        <div class="card-body">
                            ...
                            <p class="text-muted small mb-2">
                                ...
                                {{ \Carbon\Carbon::parse($relatedEvent->tanggal_event)->format('d M Y') }}
                            </p>

                            <a href="{{ route('user.event.show', $relatedEvent->id) }}"
